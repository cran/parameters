...
#' @keywords data
#'
#' @description A sample data set with longitudinal data, used in the vignette describing the \code{demean()} function. Health-related quality of life from cancer-patients was measured at three time points (pre-surgery, 6 and 12 months after surgery).
#'
