...
if (.runThisTest) {
  if (require("testthat") &&
    ...
    test_that("p_value", {
      ...
      testthat::expect_equal(p_value(model)$p, 0, tolerance = 0.01)
      ...
      testthat::expect_equal(p_value(model)$p[1], 0, tolerance = 0.01)
      ...
      testthat::expect_equal(p_value(model)$p[2], 0, tolerance = 0.01)
      ...
      testthat::expect_equal(p_value(model)$p[1], 0.1956467, tolerance = 0.01)
